 ...
 * @author normenhansen
 */
public class MainFixed extends SimpleApplication implements ActionListener{
    ...
    public void simpleUpdate(float tpf) {
        ...
        bulletstate.update(1); //fixed time 
